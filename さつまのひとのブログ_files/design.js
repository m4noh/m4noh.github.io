...
// jQuery Easing
jQuery.easing.easeOutQuart = function (p) {
...
$(d).ready(function(){
  $('.to-pagetop a').on('click', function(e){
    e.preventDefault();
...
app.setup.comment.form = function(){
  ...
  $('#comment-form-tools .rating-value').on({
    'mouseenter': function() {
  ...
  radio_rating_icon.on('click', function(){
    var ele = $(this);
  ...
  option_rating.on('click', function(){
    var ele = $(this);
